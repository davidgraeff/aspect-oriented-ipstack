...
IF(NOT DEFINED CMAKE_SHARED_LIBRARY_CREATE_ACXX_FLAGS)
  SET(CMAKE_SHARED_LIBRARY_CREATE_ACXX_FLAGS ${CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_ACXX_FLAGS)
  SET(CMAKE_SHARED_LIBRARY_ACXX_FLAGS ${CMAKE_SHARED_LIBRARY_C_FLAGS})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_LINK_ACXX_FLAGS)
  SET(CMAKE_SHARED_LIBRARY_LINK_ACXX_FLAGS ${CMAKE_SHARED_LIBRARY_LINK_C_FLAGS})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_RUNTIME_ACXX_FLAG)
  SET(CMAKE_SHARED_LIBRARY_RUNTIME_ACXX_FLAG ${CMAKE_SHARED_LIBRARY_RUNTIME_C_FLAG})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_RUNTIME_ACXX_FLAG_SEP)
  SET(CMAKE_SHARED_LIBRARY_RUNTIME_ACXX_FLAG_SEP ${CMAKE_SHARED_LIBRARY_RUNTIME_C_FLAG_SEP})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_RPATH_LINK_ACXX_FLAG)
  SET(CMAKE_SHARED_LIBRARY_RPATH_LINK_ACXX_FLAG ${CMAKE_SHARED_LIBRARY_RPATH_LINK_C_FLAG})
ENDIF()

IF(NOT DEFINED CMAKE_EXE_EXPORTS_ACXX_FLAG)
  SET(CMAKE_EXE_EXPORTS_ACXX_FLAG ${CMAKE_EXE_EXPORTS_C_FLAG})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_LIBRARY_SONAME_ACXX_FLAG)
  SET(CMAKE_SHARED_LIBRARY_SONAME_ACXX_FLAG ${CMAKE_SHARED_LIBRARY_SONAME_C_FLAG})
ENDIF()

# repeat for modules
IF(NOT DEFINED CMAKE_SHARED_MODULE_CREATE_ACXX_FLAGS)
  SET(CMAKE_SHARED_MODULE_CREATE_ACXX_FLAGS ${CMAKE_SHARED_MODULE_CREATE_C_FLAGS})
ENDIF()

IF(NOT DEFINED CMAKE_SHARED_MODULE_ACXX_FLAGS)
  SET(CMAKE_SHARED_MODULE_ACXX_FLAGS ${CMAKE_SHARED_MODULE_C_FLAGS})
ENDIF()
...
IF(NOT DEFINED CMAKE_SHARED_LIBRARY_LINK_ACXX_WITH_RUNTIME_PATH)
  SET(CMAKE_SHARED_LIBRARY_LINK_ACXX_WITH_RUNTIME_PATH ${CMAKE_SHARED_LIBRARY_LINK_C_WITH_RUNTIME_PATH})
