...
namespace ipstack
{
	 ...
	 */
	class ICMPv4_Socket: public RawIP_Socket, public ReceiveDemuxCallback {
	private:
		// no copies
		ICMPv4_Socket(const ICMPv4_Socket&) {}
	public:
		ICMPv4_Socket(const SocketMemory& memory) : RawIP_Socket(memory), ReceiveDemuxCallback(&memory) {}
