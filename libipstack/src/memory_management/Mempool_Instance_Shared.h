...
namespace ipstack {
	...
	//the actual API
	template<unsigned tBLOCKSIZE_1 = ipstack::IPSTACK_MANAGEMENT_BLOCKSIZE_BIG,
			unsigned tCOUNT_1 = ipstack::IPSTACK_MANAGEMENT_COUNT_BIG,
			unsigned tBLOCKSIZE_2 = ipstack::IPSTACK_MANAGEMENT_BLOCKSIZE_SMALL,
			unsigned tCOUNT_2 = ipstack::IPSTACK_MANAGEMENT_COUNT_SMALL>
			
	class Mempool_Instance_Shared : public SocketMemory {
	private:
	...
	public:
		Mempool_Instance_Shared() : SocketMemory(&pool, &buf) {}	
	};
