...
namespace ipstack
{
	 ...
	 */
	class ICMPv6_Socket: public RawIP_Socket, public ReceiveDemuxCallback {
	private:
		// no copies
		ICMPv6_Socket(const ICMPv6_Socket&) {}
	public:
		ICMPv6_Socket(const SocketMemory& memory) : RawIP_Socket(memory), ReceiveDemuxCallback(&memory) {}
